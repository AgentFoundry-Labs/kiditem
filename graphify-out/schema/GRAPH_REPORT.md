# Graph Report - schema  (2026-06-30)

## Corpus Check
- 13 files · ~21,390 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2276 nodes · 3546 edges · 109 communities (108 shown, 1 thin omitted)
...
1. `Database ERD` - 335 edges
2. `Organization` - 196 edges
3. `prisma — Shared Schema` - 136 edges
...
Cohesion: 0.05
Nodes (41): Marketplace.adapterType, Marketplace.category, Marketplace.configurableParams, Marketplace.createdAt, Marketplace.description, Marketplace.edgesJson, Marketplace.icon, Marketplace.id (+33 more)
...
Cohesion: 0.08
Nodes (33): externalOptionId canonical option identity, vendorItemId provider term, Database ERD, ChannelAdTargetDailySnapshot.externalId, ChannelAdTargetDailySnapshot.externalOptionId, ChannelAdTargetDailySnapshot.listingOptionId, ChannelListingOption.createdAt, ChannelListingOption.externalOptionId (+25 more)
...
Cohesion: 0.08
Nodes (30): AgentAuthorizationEvent.toolId, AgentInstanceToolPolicy.agentInstance, AgentInstanceToolPolicy.agentInstanceId, AgentInstanceToolPolicy.approvalMode, AgentInstanceToolPolicy.constraints, AgentInstanceToolPolicy.createdAt, AgentInstanceToolPolicy.dryRunMode, AgentInstanceToolPolicy.effect (+22 more)
...
Cohesion: 0.09
Nodes (29): ChannelAdTargetDailySnapshot.optionId, ProductOption.availableStock, ProductOption.barcode, ProductOption.commissionRate, ProductOption.costPrice, ProductOption.createdAt, ProductOption.deletedAt, ProductOption.id (+21 more)
...
Cohesion: 0.08
Nodes (27): AgentApprovalRequest.actionSnapshot, AgentApprovalRequest.agentInstance, AgentApprovalRequest.approver, AgentApprovalRequest.createdAt, AgentApprovalRequest.decidedAt, AgentApprovalRequest.decidedBy, AgentApprovalRequest.decisionReason, AgentApprovalRequest.expiresAt (+19 more)
...
Cohesion: 0.08
Nodes (25): ChannelAdTargetDailySnapshot.rawSnapshotId, ChannelListingDailySnapshot.rawSnapshotId, ChannelListingOptionDailySnapshot.rawSnapshotId, ChannelScrapeSnapshot.businessDate, ChannelScrapeSnapshot.channel, ChannelScrapeSnapshot.createdAt, ChannelScrapeSnapshot.externalId, ChannelScrapeSnapshot.externalOptionId (+17 more)
...
Cohesion: 0.10
Nodes (22): AgentApprovalRequest.approverUserId, AgentApprovalRequest.decidedByUserId, AgentApprovalRequest.requestedByUserId, AgentRunRequest.requestedByUserId, ContentGeneration.triggeredByUserId, ThumbnailGeneration.triggeredByUserId, User.agentInstance, User.agentInstanceId (+14 more)
...
Cohesion: 0.12
Nodes (18): AgentOS, AgentRunRequest.sourceWorkflowRunId, WorkflowRun.completedAt, WorkflowRun.contextData, WorkflowRun.createdAt, WorkflowRun.error, WorkflowRun.id, WorkflowRun.organizationId (+10 more)
...
### Community 75 - "Advertising schema"
Cohesion: 0.13
...
Cohesion: 0.13
Nodes (16): StockTransfer.completedAt, StockTransfer.createdAt, StockTransfer.fromWarehouse, StockTransfer.id, StockTransfer.notes, StockTransfer.option, StockTransfer.optionId, StockTransfer.optionName (+8 more)
...
### Community 97 - "Advertising schema"
Cohesion: 0.20
...
Cohesion: 0.20
Nodes (11): Organization.createdAt, Organization.id, Organization.isActive, Organization.name, Organization.slug, Organization.updatedAt, SellpiaReceiptUploadBatch.organizationId, StockTransaction.organizationId (+3 more)
...
### Community 104 - "prisma field: ChannelReconciliationItem.channel"
Cohesion: 0.40
...
### Community 107 - "prisma field: Alert.operationKey"
Cohesion: 0.67
Nodes (3): Alert.operationKey, Alert.organizationId, Alert unique(organizationId, operationKey)

## Knowledge Gaps
- **1485 isolated node(s):** `AdAction.actionType`, `AdAction.targetLabel`, `AdAction.reason`, `AdAction.priority`, `AdAction.currentValue` (+1480 more)
