...
## Corpus Check
- 13 files · ~25,032 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2636 nodes · 4282 edges · 128 communities (127 shown, 1 thin omitted)
...
1. `Database ERD` - 350 edges
2. `Organization` - 244 edges
3. `prisma — Shared Schema` - 157 edges
...
Cohesion: 0.09
Nodes (27): ContentAsset.assetKey, ContentAsset.assetType, ContentAsset.createdAt, ContentAsset.createdByUser, ContentAsset.createdByUserId, ContentAsset.deletedAt, ContentAsset.fileSize, ContentAsset.height (+19 more)
...
Cohesion: 0.10
Nodes (24): Database ERD, ChannelAdTargetDailySnapshot.listingOptionId, ChannelListingOption.barcode, ChannelListingOption.isActive, ChannelListingOptionDailySnapshot.externalId, ChannelListingOptionDailySnapshot.externalOptionId, ChannelListingOptionDailySnapshot.listingId, OrderReturnLineItem.createdAt (+16 more)
...
Cohesion: 0.11
Nodes (20): AgentApprovalRequest.approverUserId, AgentApprovalRequest.decidedByUserId, AgentApprovalRequest.requestedByUserId, AgentRunRequest.requestedByUserId, ContentWorkspaceThumbnailSelection.createdByUserId, User.agentInstance, User.avatarUrl, User.createdAt (+12 more)
...
Cohesion: 0.15
Nodes (16): AI, ContentWorkspaceThumbnailSelection.contentAsset, ContentWorkspaceThumbnailSelection.contentWorkspace, ContentWorkspaceThumbnailSelection.contentWorkspaceId, ContentWorkspaceThumbnailSelection.createdAt, ContentWorkspaceThumbnailSelection.createdByUser, ContentWorkspaceThumbnailSelection.id, ContentWorkspaceThumbnailSelection.organization (+8 more)
...
### Community 115 - "Advertising schema"
Cohesion: 0.20
...
Cohesion: 0.22
Nodes (10): Organization.createdAt, Organization.id, Organization.isActive, Organization.name, Organization.slug, Organization.updatedAt, SellpiaReceiptUploadBatch.organizationId, ThumbnailRegistrationAttempt.organizationId (+2 more)

### Community 122 - "prisma field: SourceImportRun.channelAccountId"
Cohesion: 0.29
...
### Community 123 - "prisma field: SourcingCandidate.id"
Cohesion: 0.25
