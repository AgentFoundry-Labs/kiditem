...
- [x] **EDIT-03**: GrapesJS 모드에서 "AI로 나머지 채우기" CTA를 클릭하면 빈 필드가 AI로 자동 생성된다

### 개별 요소 AI

- [x] **AI-01**: 텍스트 요소 선택 시 AI 액션 패널이 나타나고 다시쓰기/번역/축약이 동작한다
- [x] **AI-02**: 이미지 요소 선택 시 AI 편집 패널이 나타나고 배경 제거/AI 생성이 동작한다 (기존 재설계)
- [x] **AI-03**: AI 액션 중 로딩 상태 표시 + 에러 피드백 + Undo 지원
- [x] **AI-04**: AI 생성 결과를 캔버스에 실시간 반영 — 텍스트는 스트리밍, 이미지는 완성 즉시 교체. 생성 중 편집 잠금
...
*Last updated: 2026-03-27 — v2.1 milestone complete*
