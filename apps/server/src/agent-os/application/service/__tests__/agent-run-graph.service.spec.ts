  ...
  return {
    ...
    listRunRequests: async () => [
      ...
      },
      {
        ...
        agentType: 'sourcing',
        adapterType: 'openai_responses',
        latestRunId: 'run-sourcing-1',
        source: 'agent_os_delegation',
        triggerDetail: null,
        reason: null,
        idempotencyKey: 'operator:request-operator-1:sourcing:sourcing_agent:abc',
        priority: 0,
        sourceWorkflowRunId: null,
        sourceWorkflowNodeId: null,
        sourceResourceType: 'agent_conversation',
        ...
        requestedByActorId: 'run-operator-1',
        payload: {},
        status: 'pending',
        scheduledFor: new Date('2026-05-29T00:00:01.000Z'),
        claimedAt: null,
        claimedBy: null,
        attempts: 0,
        maxAttempts: 3,
