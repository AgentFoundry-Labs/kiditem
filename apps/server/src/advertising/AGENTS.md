...
Advertising domain은 `apps/server/AGENTS.md` 의 **backend architecture contract topology**를 따른다:
...
- 3-layer 책임 분리 규칙: [`apps/server/src/products/AGENTS.md`](../products/AGENTS.md)
- Hard rewrite 4-phase contract: section above. Source models stay in
  `prisma/models/advertising.prisma` and `prisma/models/channels.prisma`.
