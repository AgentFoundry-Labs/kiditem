...
const SellpiaInventoryImportPage = dynamic(
  () => import('@/app/(inventory)/inventory-hub/components/SellpiaInventoryImport'),
  { ssr: false },
);
  ...
  return (
    <TabLayout
      ...
      tabs={[
        ...
        {
          id: 'sellpia-sync',
          label: 'Sellpia 재고 가져오기',
          icon: RefreshCw,
          content: <SellpiaInventoryImportPage />,
        },
