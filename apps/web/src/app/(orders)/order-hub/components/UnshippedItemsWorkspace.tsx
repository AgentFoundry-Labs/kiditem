...
import UnshippedSummaryCards from "@/app/(inventory)/unshipped-items/components/UnshippedSummaryCards";
import UnshippedItemsTable, {
  type UnshippedItem,
} from "@/app/(inventory)/unshipped-items/components/UnshippedItemsTable";

export function UnshippedItemsWorkspace({ headingLevel = 2 }: { headingLevel?: 1 | 2 }) {
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            <Heading className="page-title">미배송 조회</Heading>
