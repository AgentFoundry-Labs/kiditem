...
describe('OrderMatching', () => {
  ...
  it('projects the current order line items with their order, option, SKU, and quantity', () => {
  ...
  it('routes matching work to channel metadata without a fake local success action', () => {
    render(<OrderMatching />);
