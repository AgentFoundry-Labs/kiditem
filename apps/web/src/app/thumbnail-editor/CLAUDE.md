...
### 8. ImageUploader — FileReader 추상화
...
| ROLE_CONFIG 변경 (role 추가 등) | `apps/web/src/lib/hub-roles.ts` (단일 source) + `image-hub/components/ImageGrid.tsx` + `HubInlinePicker.tsx` (양쪽에서 import, drift 확인) |
