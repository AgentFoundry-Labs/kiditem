    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="page-title">거래 현황</h1>
          </div>
        </div>
        <select
          value={selectedId}
      ...
      {summary && (
        <div className="grid grid-cols-4 gap-3">
          <div className="card">
            <div className="card-label mb-1">총 발주</div>
            <div className="card-value tabular-nums">{summary.orderCount}건</div>
          </div>
          <div className="card">
            <div className="card-label mb-1">총 거래금액</div>
            <div className="card-value tabular-nums">{formatKRW(summary.totalOrdered)}원</div>
          </div>
          <div className="card">
            <div className="card-label mb-1">지불 완료</div>
            <div className="card-value text-green-600 tabular-nums">{formatKRW(summary.totalPaid)}원</div>
          </div>
          <div className="card">
            <div className="card-label mb-1">미결제</div>
            <div className="card-value text-red-600 tabular-nums">{formatKRW(summary.unpaid)}원</div>
          </div>
        </div>
      )}
