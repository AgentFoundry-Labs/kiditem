...
import { ActionBoardOverlay } from './ActionBoardOverlay';
import { AgentNetworkCanvas } from './AgentNetworkCanvas';
import { AgentOsBottomDashboard } from './AgentOsBottomDashboard';
import { AgentOsHeader } from './AgentOsHeader';
import { AgentsListPanel } from './AgentsListPanel';
import { LiveActivityPanel, type RecentLog } from './LiveActivityPanel';
import {
  classifyAction,
...
export function AgentOsNetworkSurface({ rightPanel }: { rightPanel?: ReactNode }) {
...
export default AgentOsNetworkSurface;
