...
import { ScoreBreakdown } from '../../_shared/components/thumbnails/ScoreBreakdown';
...
export function UploadAnalyzer({ onAnalyzed }: UploadAnalyzerProps) {
  ...
  const openUploadedImageEditor = (url: string) => {
    router.push(thumbnailGenerationEditHref({ imageUrl: url }));
  };
                      ...
                      <div className="mt-3 pt-3 border-t border-slate-100">
                        ...
                        {isWarn && (
                          <div className="space-y-2">
                            ...
                            <button
                              disabled={!r.imageUrl}
                              onClick={() => r.imageUrl && openUploadedImageEditor(r.imageUrl)}
