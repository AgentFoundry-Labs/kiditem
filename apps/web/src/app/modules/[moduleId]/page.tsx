...
import CSModule from '@/components/modules/CSModule';
    ...
    <div className="space-y-6 max-w-[1200px]">
      ...
      <div className="glass-card p-6 relative overflow-hidden">
        ...
        <div className="relative flex items-start justify-between">
          <div className="flex items-start gap-4">
            ...
            <div>
              <h1 className="text-xl font-bold text-gray-900">{desc?.title || moduleData.nameKo}</h1>
          ...
          <button
            ...
            className={cn(
              ...
              moduleData.isActive
                ? 'bg-green-50 text-green-600 border border-emerald-500/20 hover:bg-emerald-500/20'
      ...
      {!['order', 'accounting', 'inventory', 'cs', 'report'].includes(moduleId) && desc && (
        <div className="glass-card p-5">
          <h2 className="text-sm font-semibold text-gray-900 mb-3">자동화 항목</h2>
      ...
      {/* Workflows */}
      <div>
        <h2 className="text-sm font-semibold text-gray-900 mb-3">워크플로우</h2>
        {workflows.length > 0 ? (
