...
const STATUS_LABEL: Record<string, string> = {
  ...
  exact_name_option: '상품명+옵션 확정', exact_name: '상품명 완전일치 확정',
  high_confidence_name: '고신뢰 상품명 확정', identifier_name_mismatch: '상품코드·상품명 불일치',
  quantity_review: '수량 검토 필요',
