...
describe('<VariantLinkDialog>', () => {
  it('confirms option-to-ProductVariant only within the already linked product', async () => {
    ...
    vi.mocked(useChannelVariantCandidates).mockReturnValue({
      data: { items: [{
        productVariantId: '44444444-4444-4444-8444-444444444444', masterProductId: '33333333-3333-4333-8333-333333333333', code: 'CP-SKU-44444444-4444-4444-8444-444444444444', name: '분홍', optionLabel: '색상: 분홍',
    ...
    expect(screen.getByText('분홍')).toBeInTheDocument();
