...
import { Calendar, ImageIcon, Layers3, Package, Sparkles } from 'lucide-react';
import { cn, formatNumber, formatTime } from '@/lib/utils';
import type { ProductContentWorkspaceItem } from '../lib/product-content-api';

export function ProductContentWorkspaceCard({ item }: { item: ProductContentWorkspaceItem }) {
  ...
  return (
    <Link
      href={item.href}
      className="group flex min-h-[292px] flex-col overflow-hidden rounded-lg border border-[var(--border)] bg-[var(--surface)] shadow-sm transition hover:-translate-y-0.5 hover:border-[var(--primary)] hover:shadow-md"
    >
