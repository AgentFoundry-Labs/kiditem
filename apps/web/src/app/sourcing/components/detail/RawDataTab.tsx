        ...
        {images.length > 0 ? (
          <div className="grid grid-cols-2 sm:grid-cols-4 md:grid-cols-6 lg:grid-cols-8 gap-3">
            {images.map((url, idx) => (
              <div
                key={`raw-img-${idx}`}
                className="aspect-square rounded-lg border border-slate-200 overflow-hidden cursor-pointer hover:border-purple-500 hover:ring-2 hover:ring-purple-200 transition-all bg-slate-50 group relative"
