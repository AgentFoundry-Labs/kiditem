        ...
        <div className="space-y-6 p-6">
          ...
          <div className="bg-white rounded-xl border border-gray-200 p-5">
            <div className="space-y-3">
              <div className="flex items-center justify-between">
                ...
                <span className={`text-xs font-medium ${nameLength > 100 ? 'text-red-500' : 'text-gray-400'}`}>
                  {nameLength}/100자
                </span>
              </div>
              <input
          ...
          {editData.productInfo.length > 0 && (
            <div className="bg-white rounded-xl border border-gray-200 p-5">
              <div className="space-y-3">
                <div className="flex items-center justify-between">
                  <label className="text-sm font-semibold text-gray-700">상품정보제공공시</label>
    ...
    case 'detail':
      return (
        <div className="p-6 space-y-4">
          <div className="flex items-center justify-between">
            <h3 className="text-sm font-bold text-gray-700">생성된 상세페이지</h3>
