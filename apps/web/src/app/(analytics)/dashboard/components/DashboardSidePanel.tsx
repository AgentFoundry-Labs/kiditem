...
function DashboardAlertRow({
  ...
  const href = alert.href ?? (alert.type === 'strategy_change' ? '/ad-ops' : alert.type === 'stock_low' ? '/purchase-orders' : alert.type === 'minus_product' ? '/product-hub?tab=cleanup' : alert.type === 'ad_high' ? '/ad-ops' : undefined);
