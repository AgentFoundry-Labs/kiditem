...
export function ReturnFaultSplit({ faultSplit }: Props) {
  ...
  return (
    <div className="bg-white rounded-lg border border-slate-200 p-6">
      <h3 className="text-base font-semibold text-slate-900 mb-4">귀책 구분</h3>
      <div className="space-y-4">
        ...
        <div className="flex gap-6">
          <div className="flex items-center gap-2">
            ...
            <span className="text-sm text-slate-700">고객 귀책</span>
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="text-sm text-slate-700">판매자 귀책</span>
            <span className="text-sm font-semibold text-slate-900">
