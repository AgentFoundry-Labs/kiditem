  ...
  return (
    <div className="grid grid-cols-3 gap-4">
      <div className="bg-white rounded-lg border border-slate-200 p-4 flex items-center gap-3">
        ...
        <div>
          <p className="text-xs text-slate-500">오늘 주문 수</p>
          <p className="text-xl font-bold text-slate-900">{todayOrderCount}건</p>
        </div>
      </div>
      <div className="bg-white rounded-lg border border-slate-200 p-4 flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-xl font-bold text-slate-900">{formatKRW(todayRevenue)}원</p>
        </div>
      </div>
      <div className="bg-white rounded-lg border border-slate-200 p-4 flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-xl font-bold text-slate-900">{pendingConfirmCount}건</p>
        </div>
      </div>
    </div>
  );
