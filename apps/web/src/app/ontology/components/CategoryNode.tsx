...
function CategoryNode({ data }: NodeProps) {
  return (
    <div className="w-[200px] bg-white border border-slate-200 rounded-lg p-3 shadow-sm">
      ...
      <div className="flex items-center gap-2 mb-1">
        ...
        <span className="text-sm font-medium text-slate-900 truncate">{data.label}</span>
      </div>
