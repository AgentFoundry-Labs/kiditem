  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-4">
        <h2 className="text-lg font-semibold text-gray-900">자동화 모듈</h2>
            ...
            >
              ...
              <div className="flex items-start justify-between mb-4 relative">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h3 className="text-sm font-semibold text-gray-900">{module.nameKo}</h3>
              ...
              {module.isActive && (
                <div className="grid grid-cols-3 gap-3 mb-4">
                  <div>
                    <p className="text-lg font-bold text-gray-900">{module.activeWorkflows}</p>
                    <p className="text-[10px] text-gray-600">워크플로우</p>
                  </div>
                  <div>
                    <p className="text-lg font-bold text-green-600">{module.todayExecutions}</p>
