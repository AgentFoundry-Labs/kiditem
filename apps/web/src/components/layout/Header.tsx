          ...
          {dropdownOpen && (
            <div className="absolute right-0 top-full mt-2 w-96 bg-white rounded-xl border border-slate-200 shadow-lg z-50 overflow-hidden">
              <div className="flex items-center justify-between px-4 py-3 border-b border-slate-100">
                ...
                {unreadCount > 0 && (
                  <button onClick={markAllAsRead} className="text-xs text-purple-600 hover:text-purple-800 font-medium">
                    모두 읽음
                  </button>
                )}
              </div>
              ...
              {alerts.length > 0 && (
                <div className="border-t border-slate-100 px-4 py-2">
                  <button
                    ...
                    className="w-full text-center text-xs text-purple-600 hover:text-purple-800 font-medium py-1"
                  >
                    더보기
                  </button>
                </div>
