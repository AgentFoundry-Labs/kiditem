            ...
            {searchable && (
              <div className="relative">
                ...
                <input
                  ...
                  className="w-48 pl-8 pr-3 py-1.5 bg-white border border-gray-200 rounded-lg text-xs text-gray-700 placeholder:text-gray-700 focus:outline-none focus:border-blue-500/30"
                />
              </div>
            )}
            {actions}
            ...
            {paged.length === 0 ? (
              ...
              paged.map((item, idx) => (
                <tr
                  ...
                  className={cn(
                    'border-b border-gray-200/50 transition-colors',
                ...
                >
                  {columns.map((col) => (
                    <td
                      key={col.key}
                      className={cn(
                        'px-5 py-3 text-xs text-gray-500 whitespace-nowrap',
                        col.align === 'right' ? 'text-right' : col.align === 'center' ? 'text-center' : 'text-left'
                      )}
                    >
        ...
        <div className="flex items-center justify-between px-5 py-3 border-t border-gray-200">
          ...
          <div className="flex items-center gap-1">
            <button
              ...
              disabled={page === 0}
              className="p-1.5 rounded-lg hover:bg-gray-50 disabled:opacity-30 text-gray-500 transition-colors"
            >
