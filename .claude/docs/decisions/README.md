...
- `AGENTS.md` = 현재 시점의 공유 규칙 + 핵심 운영 절차 + 프로세스 교훈 ("지금 이렇게 한다" — 시작/검증/커밋/PR + No follow-up/DI verification 포함)
- `CLAUDE.md` = Claude-specific addenda + 아직 `AGENTS.md`로 이관되지 않은 scoped compatibility layer
...
**대상 아님**: 리팩터링, 버그픽스, 기능 추가, 스타일 변경, 문서 작업, 단일 도메인 내부 구현 선택, ADR-0019 범위 안의 same-business-domain cross-layer 실행 선택.
...
| [0012](0012-prisma-multi-file-schema.md) | Prisma v7 multi-file schema with namespace annotations | Accepted | 2026-04-17 | prisma, apps/server, packages/shared |
| [0013](0013-product-schema-3layer.md) | Product schema 3-layer redesign (non-coexistence) | Accepted | 2026-04-17 | prisma, apps/server, apps/server/src/products, apps/web, packages/shared |
| [0014](0014-stock-mutation-single-writer.md) | InventoryService 단독 Writer for Inventory.currentStock | Accepted | 2026-04-18 | prisma, apps/server, apps/server/src/inventory, apps/server/src/products |
| [0015](0015-order-schema-unification.md) | Order schema channel-agnostic unification | Accepted | 2026-04-18 | prisma, apps/server, apps/server/src/orders, apps/server/src/channels, packages/shared |
| [0016](0016-profit-loss-live-aggregation.md) | profit-loss Live Aggregation (ProfitLoss Table Bypass) | Accepted | 2026-04-20 | apps/server, apps/server/src/finance |
| [0017](0017-returnrate-semantic-unification.md) | returnRate Semantic Unification + Orphan Return Policy | Accepted | 2026-04-20 | apps/server/src/channels |
| [0018](0018-dashboard-idor-sweep-raw-sql-tenancy.md) | Dashboard IDOR Sweep + $queryRaw Tenancy Guarantee | Accepted | 2026-04-21 | apps/server/src/dashboard |
| [0019](0019-business-domain-scoped-session-boundary.md) | Business-domain scoped session boundary | Accepted | 2026-04-24 | prisma, apps/server, apps/web, agents, packages/shared, packages/templates |
| [0020](0020-channel-option-external-id.md) | Channel Option External ID Naming | Accepted | 2026-04-24 | prisma, apps/server, apps/server/src/channels, apps/server/src/advertising, packages/shared |
| [0021](0021-generated-schema-navigation-graphs.md) | Generated schema navigation graphs | Accepted | 2026-04-26 | prisma, apps/server, packages/shared |
| [0022](0022-master-source-barcode-semantics.md) | Master source barcode semantics | Accepted | 2026-04-26 | prisma, apps/server, apps/server/src/products, apps/web, packages/shared |
...
- [0012](0012-prisma-multi-file-schema.md) — Prisma v7 multi-file schema with namespace annotations
- [0013](0013-product-schema-3layer.md) — Product schema 3-layer redesign (non-coexistence)
- [0014](0014-stock-mutation-single-writer.md) — InventoryService 단독 Writer for Inventory.currentStock
- [0015](0015-order-schema-unification.md) — Order schema channel-agnostic unification
- [0019](0019-business-domain-scoped-session-boundary.md) — Business-domain scoped session boundary
- [0020](0020-channel-option-external-id.md) — Channel Option External ID Naming
- [0021](0021-generated-schema-navigation-graphs.md) — Generated schema navigation graphs
- [0022](0022-master-source-barcode-semantics.md) — Master source barcode semantics
...
- [0014](0014-stock-mutation-single-writer.md) — InventoryService 단독 Writer for Inventory.currentStock
- [0015](0015-order-schema-unification.md) — Order schema channel-agnostic unification
- [0016](0016-profit-loss-live-aggregation.md) — profit-loss Live Aggregation (ProfitLoss Table Bypass)
...
- [0015](0015-order-schema-unification.md) — Order schema channel-agnostic unification
- [0017](0017-returnrate-semantic-unification.md) — returnRate Semantic Unification + Orphan Return Policy
- [0020](0020-channel-option-external-id.md) — Channel Option External ID Naming
