...
export const DetailPageDataSchema = z.object({
  ...
  sizeGuideOverlay: z.boolean().default(true),
  sizeHeightLabel: z.string().default(''),
  sizeWidthLabel: z.string().default(''),
  colorImages: z.array(z.string()).default([]),
  colorDisplayMode: z.string().default('normal'),
  usageImages: z.array(z.string()).default([]),
  usageSubtitle: z.string().default(''),
  detailImages: z.array(z.string()).default([]),
  detailPackageImages: z.array(z.string()).default([]),
  detailPackageLabel: z.string().default(''),
  safetyLabelImages: z.array(z.string()).default([]),
  ...
  sizeTitle: z.string().default('제품 사이즈'),
...
const SNAKE_TO_CAMEL: Record<string, string> = {
  ...
  size_guide_overlay: 'sizeGuideOverlay',
  size_height_label: 'sizeHeightLabel',
  size_width_label: 'sizeWidthLabel',
  color_images: 'colorImages',
  color_display_mode: 'colorDisplayMode',
  usage_images: 'usageImages',
  usage_subtitle: 'usageSubtitle',
  detail_images: 'detailImages',
  detail_package_images: 'detailPackageImages',
  detail_package_label: 'detailPackageLabel',
  safety_label_images: 'safetyLabelImages',
