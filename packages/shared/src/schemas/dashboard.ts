...
// DashboardAlertItemSchema — dashboard card projection (nullable optional targetType/targetId).
...
// (Plan B2c.dashboard T9 — was `productId`; DB schema has `targetType + targetId`)
