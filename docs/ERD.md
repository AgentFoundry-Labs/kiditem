...
| CoupangProductListing | Channels | `coupang_product_listings` | 쿠팡 로켓 supplier 등록 상품(vendorSearch) 카탈로그 + KidItem 매칭/번들 연결 상태. |
...
erDiagram
  ...
  Organization ||--o{ CoupangProductListing : "organization"
