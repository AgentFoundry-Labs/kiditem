...
| automatic web claim/join/heartbeat/cancel, one-retry purchase recovery, preserved direct-route UI plus additive freshness/recipe views | React/Vitest behavior tests + production web build and browser comparison against the pre-SDD/staging baseline |
