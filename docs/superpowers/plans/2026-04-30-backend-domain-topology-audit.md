...
- `apps/server/src/workflows/CLAUDE.md`.
...
npm run dev:server
npm exec --workspace=apps/server -- vitest run src/automation src/agent-registry src/rules src/workflows src/marketplace
```
