...
- Branch baseline: `origin/main` is at `485a81c` (PR #95 merged on 2026-04-29). New reconstruction branches start from current `origin/main`.
...
- Knip `Unused files` is no longer part of the baseline after PR #95. The remaining export/type cleanup surface is classified in [`2026-04-29-knip-export-risk-map.md`](./2026-04-29-knip-export-risk-map.md); use that map before deleting or internalizing public-looking exports.
