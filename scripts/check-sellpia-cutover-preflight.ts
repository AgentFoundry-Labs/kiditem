  ...
  const crossTenantForeignKeys = await prisma.$queryRaw<IssueRow[]>`
    WITH relation_specs(relation_name, child_table, child_fk, parent_table) AS (
      VALUES
        ...
        ('content_workspace_current_detail_artifact', 'content_workspaces', 'current_detail_page_artifact_id', 'detail_page_artifacts'),
        ('content_workspace_current_detail_revision', 'content_workspaces', 'current_detail_page_revision_id', 'detail_page_revisions'),
        ...
        ('product_preparation_selected_detail_artifact', 'product_preparations', 'selected_detail_page_artifact_id', 'detail_page_artifacts'),
        ('product_preparation_selected_detail_revision', 'product_preparations', 'selected_detail_page_revision_id', 'detail_page_revisions'),
        ('product_preparation_selected_detail_generation', 'product_preparations', 'selected_detail_page_generation_id', 'content_generations'),
        ('product_preparation_selected_thumbnail_generation', 'product_preparations', 'selected_thumbnail_generation_id', 'thumbnail_generations'),
        ('product_preparation_selected_thumbnail_candidate', 'product_preparations', 'selected_thumbnail_generation_candidate_id', 'thumbnail_generation_candidates'),
